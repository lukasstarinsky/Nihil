...
#define FOR_OPENGL_FUNCTIONS(ACTION) \
    ...
    ACTION(PFNGLDRAWELEMENTSINSTANCEDPROC, glDrawElementsInstanced) \
    ACTION(PFNGLDRAWELEMENTSBASEVERTEXPROC, glDrawElementsBaseVertex) \
    ...
    ACTION(PFNGLVERTEXARRAYBINDINGDIVISORPROC, glVertexArrayBindingDivisor) \
